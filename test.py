...
print(check_sum(0, 0))    # Выведет: "Числа равны друг другу"
print(check_sum(-1, -2))  # Выведет: "Числа негативные"
print(check_sum(-3, 3))   # Выведет: "Числа негативные"
